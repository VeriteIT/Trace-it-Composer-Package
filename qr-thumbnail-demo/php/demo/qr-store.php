...
final class QrStore
{
    ...
    private function mint(string $articleId, string $destinationUrl, ?string $title): array
    {
        ...
        /*
         * Trace-It API, VERIFIED against its source (the Trace-It API,
         * the Trace-It API) and public/docs/api.html.
         *
         ...
         * 400 invalid_target_url (normaliseTargetUrl in the Trace-It API).
         *
    ...
    /**
     * Trace-It's postId rules, from sanitizePostId() in the Trace-It API:
