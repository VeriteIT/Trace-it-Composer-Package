 ...
 *
 * VERIFIED against the Trace-It source (Next.js app, the Trace-It API,
 * the Trace-It API) and its client-facing doc (public/docs/api.html). Earlier
...
/**
 * Trace-It's postId rules, copied from sanitizePostId() in the Trace-It API:
...
async function mintQr({ articleId, destinationUrl, title, followUpPages }) {
   ...
   * 400 invalid_target_url (see normaliseTargetUrl in the Trace-It API).
   *
